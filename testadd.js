...
//     addId = list.lenght;
//      addName =  $('#nameEdit').val(this.name);
//      addInit = $('#initEdit').val(this.init);
//      addAC = $('#acEdit').val(this.ac);
//      addHP = $('#hpEdit').val(this.hp);
//      addNew = new Character(addId, addName, addInit, addAC, addHP);
//     list.push(addNew);
//     console.log(list);
//   });
// });
